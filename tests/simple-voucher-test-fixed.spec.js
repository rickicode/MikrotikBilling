...
/**
 * FIXED VOUCHER GENERATION TEST WITH MIKROTIK VERIFICATION
 */
...
// Single test to avoid connection issues
test.describe('Fixed Voucher Generation with Mikrotik Verification', () => {
  
  test('Complete Voucher Generation and Verification Workflow', async ({ page }) => {
    ...
    try {
      ...
      await expect(page.locator('h1, .page-title')).toContainText('Voucher', { timeout: 10000 }); // Fixed: accepts "Voucher Hotspot"
      ...
      await page.screenshot({ path: 'test-results/screenshots/fixed-form-filled.png', fullPage: true });
      ...
      if (page.url().includes('/print/')) {
        ...
        await page.screenshot({ path: 'test-results/screenshots/fixed-print-page.png', fullPage: true });
      } else {
        ...
        await page.screenshot({ path: 'test-results/screenshots/fixed-result-page.png', fullPage: true });
      }
      ...
      await page.screenshot({ path: 'test-results/screenshots/fixed-final-dashboard.png', fullPage: true });
      ...
      console.log('\n🎉 FIXED VOUCHER GENERATION TEST PASSED!');
      ...
      // Print test results
      console.log('\n' + '='.repeat(60));
      console.log('🎯 FIXED VOUCHER GENERATION TEST RESULTS');
