...
/**
 * VOUCHER GENERATION TEST - SIMPLE VERSION
 */
...
test.describe('Voucher Generation Test', () => {
  ...
  test('should login and generate vouchers', async ({ page }) => {
    ...
    // Note: Mikrotik RouterOS verification would require proper credentials
    // This test focuses on the web interface voucher generation workflow
    console.log('ℹ️ Mikrotik RouterOS verification skipped - requires proper credentials');
  });
});
